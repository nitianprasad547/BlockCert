...
export default function DemoModal({ type, onClose }: DemoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/85 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-lg rounded-3xl glass-panel border border-emerald-500/40 bg-slate-900/95 p-6 sm:p-8 shadow-2xl space-y-6 text-left">
            ...
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-md bg-emerald-500/10 border border-emerald-500/30 px-3 py-1 text-xs font-bold text-emerald-400">
                ...
                <span className="uppercase tracking-wider">
                  {type === "demo" ? "BLOCKCERT INSTITUTIONAL ONBOARDING" : "SECURITY ENGINEERING CONTACT"}
                </span>
              </div>
              <h3 className="text-2xl font-bold text-white">
                {type === "demo" ? "Schedule BlockCert Pilot Demo" : "Contact BlockCert Security Engineers"}
              </h3>
              <p className="text-xs text-slate-400">
                Experience Ed25519 credential signing, single-node tamper-evident hash chains, and instant QR verification.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="py-8 text-center space-y-4 animate-fadeIn">
                ...
                <p className="text-xs text-slate-300 max-w-xs mx-auto">
                  Our integration team will reach out to <strong>{formData.email || "your email"}</strong> within 4 business hours.
                </p>
                <button
                  type="button"
                  onClick={resetAndClose}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="CTO">Chief Information Officer / Dean</option>
                    <option value="Licensing">Professional Accreditation Agency</option>
                    <option value="Employer">Enterprise Verification Partner</option>
                  </select>
                </div>
